...
export default function Flame({
  ...
  return (
    <div className={cn("relative left-1/2 -translate-x-1/2 *:before:absolute *:before:content-[''] *:after:absolute *:after:content-['']", className)}>
      ...
      {/* Orange flame */}
      <div className="absolute w-7.5 left-1/2 bottom-0 rounded-[100%_100%_30%_30%] bg-[linear-gradient(white_80%,transparent)] animate-[var(--animate-move-flame),var(--animate-enlarge-flame)] before:w-full before:h-full before:rounded-[100%_100%_30%_30%] before:shadow-[0_0_15px_0_rgba(247,93,0,0.4),0_-6px_4px_0_rgba(247,128,0,0.7)]"/>
    </div>
  );
}