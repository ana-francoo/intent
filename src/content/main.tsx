...
function injectOverlay() {
  ...
  overlay.style.background = 'rgba(58, 58, 58, 0.88)';
  ...
  style.textContent = `
    ...
    *, *:before, *:after { margin: 0; padding: 0; box-sizing: border-box; }
    html { font-size: 10px; }
    #intent-overlay-film { font-family: 'Ubuntu', sans-serif; background: transparent !important; color: white; height: 100vh; width: 100vw; position: fixed; top: 0; left: 0; z-index: 2147483647; }
  ...
  textInput.addEventListener('keydown', (e) => {
    if (e.key === 'Enter' && textInput.value.trim()) {
      ...
      containerDiv.innerHTML = `
        <svg viewBox="0 0 100 100" style="stroke-width:3.2;">
